...
.focus-panel h2 { margin: 0 0 18px; font-size: clamp(1.85rem, 3vw, 2.65rem); line-height: 1.05; }.focus-panel > p:not(.panel-eyebrow) { margin: 0 0 25px; color: oklch(89% .02 55); font-size: .9rem; line-height: 1.65; }.focus-panel ul { display: grid; gap: 9px; margin: 0; padding: 0; list-style: none; color: oklch(87% .016 55); font-size: .8rem; }.focus-panel li { display: flex; gap: 9px; align-items: center; }.focus-panel li::before { width: 4px; height: 4px; border-radius: 50%; background: var(--accent); content: ""; }
