...
h1 { margin: 0 0 10px; font-size: clamp(3.6rem, 8.1vw, 7.2rem); line-height: .94; }
...
.panel-eyebrow, .card-label { margin: 0 0 28px; color: color-mix(in oklch, var(--accent) 82%, white); font-size: .72rem; font-weight: 700; letter-spacing: .05em; }
.focus-panel h2 { margin: 0 0 18px; font-size: clamp(1.85rem, 3vw, 2.65rem); line-height: 1.05; }.focus-panel > p:not(.panel-eyebrow) { margin: 0 0 25px; color: oklch(89% .02 145); font-size: .9rem; line-height: 1.65; }.focus-panel ul { display: grid; gap: 9px; margin: 0; padding: 0; list-style: none; color: oklch(87% .016 145); font-size: .8rem; }.focus-panel li { display: flex; gap: 9px; align-items: center; }.focus-panel li::before { width: 4px; height: 4px; border-radius: 50%; background: var(--accent); content: ""; }
.rotation-feature { display: grid; grid-template-columns: minmax(0, 1.35fr) minmax(230px, .65fr); gap: 38px; max-width: 1100px; margin: 0 auto clamp(120px, 17vw, 210px); padding: clamp(30px, 5vw, 56px); }.feature-copy h2, .section-heading h2 { margin: 0 0 18px; font-size: clamp(2.2rem, 4.4vw, 4.4rem); line-height: .98; }.feature-copy > p:last-child, .feature-detail { color: var(--muted); font-size: .9rem; line-height: 1.65; }.feature-detail { align-self: end; padding-left: 22px; border-left: 1px solid var(--line-strong); }.feature-detail p { margin: 0 0 8px; color: var(--text); font-weight: 600; }.feature-detail span { color: var(--quiet); }
.content-section { max-width: 1100px; margin: 0 auto clamp(120px, 17vw, 210px); }.section-heading { display: grid; grid-template-columns: minmax(0, 1fr) minmax(230px, .65fr); align-items: end; gap: 40px; margin-bottom: 46px; }.section-heading > p { max-width: 32ch; margin: 0 0 5px; color: var(--muted); font-size: .9rem; line-height: 1.65; }.content-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; }.content-card { min-height: 250px; padding: 26px; border: 1px solid var(--line); border-radius: 16px; background: var(--surface); }.content-card-wide { grid-column: span 2; min-height: 230px; }.content-card-emphasis { background: oklch(23% .032 155); }.card-label { margin-bottom: 66px; color: var(--accent); }.content-card h3 { max-width: 18ch; margin: 0 0 11px; font-size: clamp(1.35rem, 2.4vw, 2rem); line-height: 1.12; }.content-card p:last-child { max-width: 42ch; margin: 0; color: var(--muted); font-size: .85rem; line-height: 1.62; }
...
@media (max-width: 820px) { .hero, .rotation-feature, .section-heading { grid-template-columns: 1fr; }.hero { gap: 42px; min-height: auto; }.focus-panel { max-width: 520px; }.feature-detail { padding: 22px 0 0; border-top: 1px solid var(--line-strong); border-left: 0; } } @media (max-width: 620px) { .site-shell { padding-inline: 14px; }.hero { padding-top: 90px; }h1 { font-size: clamp(3.2rem, 16vw, 5rem); }.hero-topic { font-size: 1.65rem; }.rotation-feature { gap: 26px; padding: 25px; }.content-grid { grid-template-columns: 1fr; }.content-card-wide { grid-column: auto; }.content-card { min-height: 220px; }.footer { flex-direction: column; align-items: flex-start; gap: 9px; } }
</style>
