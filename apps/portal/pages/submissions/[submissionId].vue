...
<style scoped>
.submission-page { min-height: 100svh; padding: 40px clamp(16px, 8vw, 120px); color: oklch(18% 0.02 55); background: oklch(94% 0.025 80); font-family: "Avenir Next", "Noto Sans CJK SC", sans-serif; }
...
.card { width: min(100%, 720px); max-width: 720px; padding: clamp(20px, 5vw, 28px); border: 1px solid oklch(18% 0.02 55 / 18%); background: oklch(98% 0.01 80 / 70%); }
dl { margin: 0; }
