...
function handleKeydown(event: KeyboardEvent) { if (event.key === "Escape" && selected.value) closeSelected(); }
...
@media (max-width: 820px) { .admin-grid { grid-template-columns: 1fr; gap: 70px; } }
