  ...
  it("marks owned achievements and keeps owned historical titles visible", async () => {
    const wrapper = await mountSuspended(AchievementCatalog, {
      props: {
        ...
        ownedTitles: [
          { grantId: "grant-1", titleKey: "TEST", label: "测试称号", icon: "trophy", iconUrl: null, category: "测试", condition: "完成挑战", scope: "global", grantedAt: 2 },
          { grantId: "grant-2", titleKey: "HISTORICAL", label: "历史称号", icon: "scroll", iconUrl: null, category: "旧记录", condition: "完成旧挑战", scope: "global", grantedAt: 1 },
        ],
      },
    });
